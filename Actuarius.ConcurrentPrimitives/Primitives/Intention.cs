namespace Actuarius.ConcurrentPrimitives
{
    ...
    public sealed class Intention
    {
        ...
        private volatile int _intention = 0;

        public State CurState => (State)_intention;
        ...
        public bool Set()
        {
            int old = System.Threading.Interlocked.CompareExchange(ref _intention, (int)State.HasIntention, (int)State.NoIntention);
        ...
        {
            int old = System.Threading.Interlocked.CompareExchange(ref _intention, (int)State.HadIntention, (int)State.HasIntention);
